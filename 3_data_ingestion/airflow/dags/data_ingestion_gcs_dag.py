...
decompressed_file = dataset_file.replace('.gz', '')
...
with DAG(
    ...
    decompress_dataset_task = BashOperator(
        ...
        bash_command=f"gzip -fd {path_to_local_home}/{dataset_file}"
    )
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"landing/{parquet_file}",
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/landing/{parquet_file}"],
            },
        },
    )
    
    download_dataset_task >> decompress_dataset_task
    decompress_dataset_task >> format_to_parquet_task
